...
## Reference Files
- `references/alternative-bounty-platforms.md` — Curated list of alternative bug bounty platforms beyond H1/Bugcrowd/Immunefi/Superteam, with reward ranges and fit analysis. Use when the user asks "where else can I hunt?" or when current platforms feel tapped out.
