...
| CORS reflected origin + Authorization header | Server Security Misconfiguration > Other (justify: cross-client data access via credentialed CORS) | Broken Access Control > Improper Access Control > P3 |
...
## Reference Files
- `references/bugcrowd-evidence-collection-workflow.md` — 10-step evidence collection workflow for Bugcrowd submissions (screenshots + evidence.md). Use when the user asks for structured evidence attachment.
